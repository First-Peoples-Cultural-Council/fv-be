...
EXACT_MATCH_PRIMARY_BOOST = 120
EXACT_MATCH_SECONDARY_BOOST = 100
EXACT_MATCH_OTHER_BOOST = 80

# Prefix matches (prioritized higher than contains and fuzzy queries)
PREFIX_MATCH_PRIMARY_BOOST = 90
PREFIX_MATCH_SECONDARY_BOOST = 70
PREFIX_MATCH_OTHER_BOOST = 50

# Substring matches in the middle or suffix (middle and suffix are equal but weaker than prefix matches)
CONTAINS_MATCH_PRIMARY_BOOST = 60
CONTAINS_MATCH_SECONDARY_BOOST = 40
CONTAINS_MATCH_OTHER_BOOST = 30
