...
#     cache.clear()
#
#     print("\n[DEBUG] Starting test with deterministic environment...")
#     print("  random_sample", random.random())
#     print("  PYTHONHASHSEED=", os.environ.get('PYTHONHASHSEED'))
#     print("  uuid4 sample", uuid.uuid4())
#
#     yield
#
#     cache.clear()
...
#         factories.FileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/minimal-media-audio.mp3", "audio/mpeg"),
#             import_job=import_job,
#         )
#         factories.FileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/minimal-media-document.pdf", "application/pdf"),
#             import_job=import_job,
#         )
#         factories.ImageFileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/minimal-media-image.jpg", "image/jpeg"),
#             import_job=import_job,
#         )
#         factories.VideoFileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/minimal-media-video.mp4", "video/mp4"),
#             import_job=import_job,
#         )
#
#         # Validating again
...
#         file_content = get_sample_file(f"import_job/related_images.csv", self.MIMETYPE)
#         file = factories.FileFactory(content=file_content)
#         import_job = factories.ImportJobFactory(
#             site=self.site,
#             run_as_user=self.user,
...
#         factories.ImageFileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/related-images-image-1.jpg", "audio/mpeg"),
#             import_job=import_job,
#         )
#         factories.ImageFileFactory(
#             site=self.site,
#             content=get_sample_file("import_job/related-images-image-2.jpg", "audio/mpeg"),
#             import_job=import_job,
#         )
#         confirm_import_job(import_job.id)
#
#         entry_with_image = DictionaryEntry.objects.get(title="Related Images CSV Word 1")
#         related_images = entry_with_image.related_images.all()
#         assert len(related_images) == 1
#         related_image = related_images[0]
#         assert (
#             get_valid_filename("related-images-image-1") in related_image.original.content.name
#         )
#
#         related_image = related_images[0]
#         self.assert_related_image_details("related-images-image-1", related_image)
...
#
#         entry_2 = DictionaryEntry.objects.get(title="Related Images CSV Word 2")
#         related_images = entry_2.related_images.all()
#         assert len(related_images) == 1
#         related_image = related_images[0]
#         assert (
#             get_valid_filename("related-images-image-2") in related_image.original.content.name
#         )
#
...
#
#         entry_with_video = DictionaryEntry.objects.get(site=self.site, title="Word 1")
...
#
#         entry_2 = DictionaryEntry.objects.get(site=self.site, title="Word 2")
