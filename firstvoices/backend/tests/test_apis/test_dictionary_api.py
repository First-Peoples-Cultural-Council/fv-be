...
from .base_api_test import BaseControlledSiBaseReadOnlyControlledSiteContentApiTestteContentApiTest
from .base_media_test import RelatedMediaTestMixin


class TestDictionaryEndpoint(RelatedMediaTestMixin, BaseReadOnlyControlledSiteContentApiTest):
    """
