...
class TestUpdateJobMediaEndpoint(
    ...
    def setup_method(self):
        ...
        self.update_job = ImportJobFactory(site=self.site, data=file)

        self.endpoint = reverse(
            self.UPLOAD_VIEW,
            current_app=self.APP_NAME,
            args=[self.site.slug, self.update_job.id],
        )
    ...
    def test_invalid_file_type(self):
        ...
        images = ImageFile.objects.filter(import_job_id=self.update_job.id)
