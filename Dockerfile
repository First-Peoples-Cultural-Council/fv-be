...
FROM --platform=arm64 django-common AS static-collector
RUN ["python3", "manage.py", "collectstatic"]

# select with --target static-runtime at build time
FROM --platform=arm64 $caddy_image AS static-runtime
...
FROM --platform=arm64 django-common AS django-runtime
EXPOSE 8000
